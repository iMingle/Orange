...
package org.mingle.orange.arithmetic.search.hash;

import edu.princeton.cs.algs4.SequentialSearchST;
import org.mingle.orange.arithmetic.base.Queue;
...
public class SeparateChainingHash<Key, Value> {
    ...
    private void resize(int chains) {
        SeparateChainingHash<Key, Value> temp = new SeparateChainingHash<>(chains);
        for (int i = 0; i < m; i++) {
