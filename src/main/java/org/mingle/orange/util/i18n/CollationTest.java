...
class CollationFrame extends JFrame {
    private static final long serialVersionUID = 6878331211424729139L;
    ...
    private EnumCombo strengthCombo = new EnumCombo(Collator.class,
            new String[] { "Primary", "Secondary", "Tertiary", "Identical" });
    private EnumCombo decompositionCombo = new EnumCombo(Collator.class,
            new String[] { "Canonical Decomposition", "Full Decomposition",
                    "No Decomposition" });
    ...
    public CollationFrame() {
        ...
        Arrays.sort(locales, new Comparator<Locale>() {
            ...
            public int compare(Locale l1, Locale l2) {
                return collator.compare(l1.getDisplayName(),
                        l2.getDisplayName());
            }
        });
