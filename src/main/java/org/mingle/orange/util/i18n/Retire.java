...
package org.mingle.orange.util.i18n;
...
public class Retire extends JApplet {
    ...
    public void initUI() {
        ...
        add(savingsField,
                new GBC(1, 1).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(contribField,
                new GBC(3, 1).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(incomeField, new GBC(5, 1).setWeight(100, 0)
                .setFill(GBC.HORIZONTAL));
        add(currentAgeField,
                new GBC(1, 2).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(retireAgeField,
                new GBC(3, 2).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(deathAgeField,
                new GBC(5, 2).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(inflationPercentField,
                new GBC(1, 3).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(investPercentField,
                new GBC(3, 3).setWeight(100, 0).setFill(GBC.HORIZONTAL));
        add(retireCanvas,
                new GBC(0, 4, 4, 1).setWeight(100, 100).setFill(GBC.BOTH));
        add(new JScrollPane(retireText), new GBC(4, 4, 2, 1).setWeight(0, 100)
                .setFill(GBC.BOTH));
    ...
    public void setCurrentLocale(Locale locale) {
        ...
        res = ResourceBundle.getBundle("org.mingle.orange.i18n.RetireResources", currentLocale);
        resStrings = ResourceBundle.getBundle("documents.i18n.RetireStrings", currentLocale);
...
class RetireCanvas extends JPanel {
    private static final long serialVersionUID = -6031438769770871700L;
    ...
    public void paintComponent(Graphics g) {
        ...
        for (i = info.getCurrentAge(); i <= info.getDeathAge(); i++) {
            ...
            Rectangle2D bar = new Rectangle2D.Double(x1, y1, barWidth - 2,
                    height);
            g2.fill(bar);
