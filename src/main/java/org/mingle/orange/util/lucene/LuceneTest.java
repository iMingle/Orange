...
package org.mingle.orange.util.lucene;
...
//        Analyzer analyzer = new StandardAnalyzer();
        ...
        try {
            StringBuilder builder = new StringBuilder((LuceneTest.class.getResource("/").getFile()
                    + "documents/lucene/directory").substring(1));
            directory = FSDirectory.open(Paths.get(builder.insert(2, "/").toString()));
            // 用来写索引文件
