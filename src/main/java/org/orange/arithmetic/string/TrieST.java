...
public class TrieST<E> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("longestPrefixOf(\"h\"):");
        System.out.println(st.longestPrefixOf("h"));
        System.out.println();

        System.out.println("longestPrefixOf(\"s\"):");
        System.out.println(st.longestPrefixOf("s"));
        System.out.println();

        System.out.println("keysWithPrefix(\"he\"):");
        for (String s : st.keysWithPrefix("he"))
            System.out.println(s);
        System.out.println();

        System.out.println("keysThatMatch(\".e.l.\"):");
        for (String s : st.keysThatMatch(".e.l."))
            System.out.println(s);
    }
}
